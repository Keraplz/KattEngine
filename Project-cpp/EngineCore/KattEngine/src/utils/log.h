...
#define KATT_LOG_LEVEL_FATAL 0
#define KATT_LOG_LEVEL_ERROR 1
#define KATT_LOG_LEVEL_WARN  2
#define KATT_LOG_LEVEL_INFO  3
...
#ifndef KATT_LOG_LEVEL
#define KATT_LOG_LEVEL KATT_LOG_LEVEL_INFO
#endif

#if KATT_LOG_LEVEL >= KATT_LOG_LEVEL_FATAL
#define SP_FATAL(...) sp::internal::log_message(KATT_LOG_LEVEL_FATAL, true, "KATT:    ", __VA_ARGS__)
#define _SP_FATAL(...) sp::internal::log_message(KATT_LOG_LEVEL_FATAL, false, __VA_ARGS__)
#else
#define SP_FATAL(...)
#define _SP_FATAL(...)
#endif

#if KATT_LOG_LEVEL >= KATT_LOG_LEVEL_ERROR
#define SP_ERROR(...) sp::internal::log_message(KATT_LOG_LEVEL_ERROR, true, "KATT:    ", __VA_ARGS__)
#define _SP_ERROR(...) sp::internal::log_message(KATT_LOG_LEVEL_ERROR, false, __VA_ARGS__)
#else
#define SP_ERROR(...)
#define _SP_ERROR(...)
#endif

#if KATT_LOG_LEVEL >= KATT_LOG_LEVEL_WARN
#define SP_WARN(...) sp::internal::log_message(KATT_LOG_LEVEL_WARN, true, "KATT:    ", __VA_ARGS__)
#define _SP_WARN(...) sp::internal::log_message(KATT_LOG_LEVEL_WARN, false, __VA_ARGS__)
#else
#define SP_WARN(...)
#define _SP_WARN(...)
#endif

#if KATT_LOG_LEVEL >= KATT_LOG_LEVEL_INFO
#define SP_INFO(...) sp::internal::log_message(KATT_LOG_LEVEL_INFO, true, "KATT:    ", __VA_ARGS__)
#define _SP_INFO(...) sp::internal::log_message(KATT_LOG_LEVEL_INFO, false, __VA_ARGS__)
#else
#define SP_INFO(...)
#define _SP_INFO(...)
#endif
